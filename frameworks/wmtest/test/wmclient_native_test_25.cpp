...
#include "wmclient_native_test_25.h"
...
namespace {
class WMClientNativeTest25 : public INativeTest {
public:
    std::string GetDescription() const override
    {
        constexpr const char *desc = "notification shade window";
        return desc;
    }
    ...
    void Run(int32_t argc, const char **argv) override
    {
        ...
        window = NativeTestFactory::CreateWindow(WINDOW_TYPE_NOTIFICATION_SHADE);
        if (window == nullptr) {
