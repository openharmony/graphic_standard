...
#include "wmclient_native_test_26.h"
...
namespace {
class WMClientNativeTest26 : public WMClientNativeTest1 {
public:
    std::string GetDescription() const override
    {
        constexpr const char *desc = "scaleto";
        return desc;
    }

    int32_t GetID() const override
    {
        constexpr int32_t id = 26;
        return id;
    }
    ...
    void AfterRun()
    {
        ...
        window->ScaleTo(width, height);

        constexpr uint32_t delayTime = 100;
        PostTask(std::bind(&WMClientNativeTest26::AfterRun, this), delayTime);
    }
