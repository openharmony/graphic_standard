...
#include "wmclient_native_test_24.h"
...
namespace {
class WMClientNativeTest24 : public INativeTest {
public:
    std::string GetDescription() const override
    {
        constexpr const char *desc = "volume overlay window";
        return desc;
    }
    ...
    void Run(int32_t argc, const char **argv) override
    {
        ...
        window = NativeTestFactory::CreateWindow(WINDOW_TYPE_VOLUME_OVERLAY);
        if (window == nullptr) {
